...
import { StyleSheet, Text, View, Image, TouchableOpacity, KeyboardAvoidingView, ActivityIndicator } from 'react-native'
      ...
      <SafeAreaView style={LoginStyle.wholeView}>
            ...
            <ScrollView>
                ...
                <TouchableOpacity
                 ...
                 onPress={() => { navigation.navigate('DummyLogin2'); }}
                >
