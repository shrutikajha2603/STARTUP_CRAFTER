...
const usersData = [
  {
    ...
    fullName: 'Amit Saha',
    city: 'Kolkata',
    skills: ['Developer', 'Python', 'Video Editor', 'Data Scientist'],
  ...
  },
  {
    ...
    city: 'Jaipur',
    skills: ['Developer', 'Premiere Pro', 'After Effects'],
  ...
  },
  {
    ...
    fullName: 'Atul Singh',
    city: 'Kolkata',
    skills: ['Graphic Designer', 'Developer', 'Adobe Illustrator', 'Typography'],
